...
class SettingsRoom extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) => _RoomScaffold(
    ...
    child: Column(children: [
      ListTile(leading: const Icon(Icons.verified_user_outlined), title: const Text('Privacy Policy'), onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const PrivacyPolicyScreen()))),
      ListTile(leading: const Icon(Icons.gavel_outlined), title: const Text('Terms of Service'), onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const TermsOfServiceScreen()))),
      ListTile(leading: const Icon(Icons.security_outlined), title: const Text('Security'), onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const SecurityScreen()))),
